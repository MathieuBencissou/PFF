...
Route::put('/register/editplayer/{id}', [App\Http\Controllers\RegisterController::class, 'EditPlayer']);

Route::get('/allusers', [App\Http\Controllers\UserController::class, 'GetUsers'])->middleware('auth:api');
...
Route::put('/challenges/addplayer/{id}', [App\Http\Controllers\ChallengesController::class, 'AddPlayer'])->middleware('auth:api');
...
Route::put('/profil/{id}', [App\Http\Controllers\UserController::class, 'EditUser'])->middleware('auth:api');
